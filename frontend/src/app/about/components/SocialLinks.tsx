 ...
 *
 * - Mobile: three circular primary-colored icon buttons (email, X/Twitter, RSS).
 * - Desktop: three small SVG icon links (Twitter/X, GitHub, LinkedIn).
 *
 * Uses responsive classes to show/hide each variant.
 */
export function SocialLinks() {
  return (
    <section className="flex flex-col items-center mb-10 px-4">
      {/* Mobile social icons */}
      <p className="md:hidden text-slate-400 text-sm font-semibold uppercase tracking-widest mb-6">
        Stay Connected
      </p>

      <div className="md:hidden flex gap-6 mb-12">
        {/* Email */}
        <a
