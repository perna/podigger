...
class Podcast(BaseModel):
    ...
    image = models.CharField(max_length=255, blank=True, null=True, default='/static/dist/img/podcast-banner.png')
    language = models.ForeignKey(PodcastLanguage, on_delete=models.SET_NULL, null=True, default=None)
