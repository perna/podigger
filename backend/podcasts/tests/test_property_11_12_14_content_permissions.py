...
def _make_user(email: str, password: str, role: str, approval_status: str = "approved") -> User:
...
def test_public_read_returns_200(endpoint):
    ...
    podcast = Podcast.objects.create(name="Public Podcast", feed="https://feed.example.com")
